...
Though out my Computer Science capstone course I was able to see how far I have come from when I first started. When I initially developed the artifacts in 2019, I felt as I was not prepared enough. It took me a while to complete a simp application, and it was not completed very well. It was the first application I made from front end to back end, so I learnt plenty of lessons. When I went back to refine the application, I was able to see how much I improved as a problem solver. I can now be faced with something I am unfamiliar with and solve the problem on my own. I have also gotten better at collaborating in a team environment. A bit after I initially created the weight tracking application, I got an internship at a technology company as a software engineer. At the internship they followed the agile development process, so have become very good at it. I was able to work closely with other developers to create an amazing application, I did so well that they ended up hiring me. We also followed a thorough code review process using Review Bored. We were not allowed to commit anything until it has been reviewed by the team, has no errors, has been completely tested, such as unit tests and etc., and received ship it’s from each person. I also the opportunity to introduce new features to the application. Before I could introduce them, I would have to pitch then to the stakeholders. I had to sell them on why my idea was an improvement which the application needed and why it was worth the development cost. The internship was a turning point for my career as software engineer. It gave me confidence and boosted my skills in software engineering, data structures and algorithms, databases, and security. The company I interned at only had people, including myself. So, this gave me the opportunity to work on every aspect of the application. I helped create an efficient SQL database and stored procedures which could store and query massive amounts of data, the only limiting factor was hardware. I even set up database maintenance jobs using Ola Hallengren SQL Server Maintenance Solution. The company I was interning at wanted the entire application to be dynamic, so any feature I added I had to add dynamically. We were developing in C# using the ASP NET Core framework. For each feature I also needed to add the API calls and stored procedure for the feature to work.  For security I worked with Microsoft Identity and Identity Server. Identity Server is the middle ware which makes integrating with OpenID Connect and OAuth 2.0 easier. 
    
The artifact I chose, a Weight Tracking created with Android Studio, to enhance shows how my skills have expanded from 2019 to 2021. It shows my skills in software design and engineering, algorithms and data structures, and databases. The application tracks the user’s daily weight to help them reach a goal they have set for themselves. I selected this item because I believe it does the best job of showcasing my skills from front end to back end. It also shows how much I have improved in such a short period of time. My software design and engineering skills can be seen in how I enhanced the main page of the application. Before I made any enhancements, it was hardcoded, repetitive and lacked functionality. Now, the hardcoded parts are dynamically added and there is a button to increase the number of days the user would like to track their weight for. My data structures and algorithm skills can be seen by the code I added which dynamically adds event listeners to the main pages table, and dynamically builds it. My database skills can be seen on how I enhanced the database to pull additional data, how many rows the main table needs, which makes the application dynamic. I completely redesigned the application and improved it in many ways. This application is a testament my growth as a developer and how far I have come in a short period of time.


Here is the code review I created before I made any changes
